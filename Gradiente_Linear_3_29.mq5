//+------------------------------------------------------------------+
//|                                   Gradiente Linear v3.29 VOLUMES |
//|                                  Copyright 2025, Trading Expert  |
//|         ✅ v3.29: COOLDOWN COM BACKOFF APÓS STOP LOSS             |
//+------------------------------------------------------------------+
...
void CriarPainel()
{
   ...
   ObjectSetString(0, "Panel_Title", OBJPROP_TEXT, "Gradient Grid v3.28");
                        ...
                        const MqlTradeResult& result)
{
   ...
   // ✅ v3.29: Bloquear processamento de deals durante cooldown
   if(emCooldown)
      return;
